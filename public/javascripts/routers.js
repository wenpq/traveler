...
var routerTable, sharedRouterTable, initRouterTable, activeRouterTable, completeRouterTable, abortedRouterTable;
...
/*function completeFromModal(archive) {
...
/*function abortFromModal(archive) {
  $('#submit').prop('disabled', true);
  var number = $('#modal .modal-body div').length;
  $('#modal .modal-body div').each(function (index) {
    var that = this;
...
$(function () {
  ...
  initTable(routerTable, '/routers/json');
